...
{
    [TableName("DNNAudioPlayer_Items")]
    ...
    public class Item
    {
        ...
        ///<summary>
        /// A Uri with a link to the Item file
        ///</summary>
        public Uri ItemFileUrl { get; set; }
        ...
        ///<summary>
        /// The link to the primary reference url
        ///</summary>
        public Uri ItemPrimaryLink { get; set; }

        ///<summary>
        /// The link to the secondary reference urls as JSON ojbect
        ///</summary>
        public String ItemSecondaryLinks { get; set; }
