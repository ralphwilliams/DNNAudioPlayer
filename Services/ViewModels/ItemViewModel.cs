...
using RalphWilliams.Modules.DNNAudioPlayer.Components;
using Newtonsoft.Json;

namespace RalphWilliams.Modules.DNNAudioPlayer.Services.ViewModels
{
    ...
    public class ItemViewModel
    {
        public ItemViewModel(Item t)
        {
            ...
            FileUrl = t.ItemFileUrl.AbsoluteUri;
        ...
        [JsonProperty("itemPrimaryLink")]
        public string ItemPrimaryLink { get; set; }
